...
$CORS_affected_scripts		= 'non_agent_api.php';	# If multiple(but less than all) scripts affected, separate them by a space (see CORS_SUPPORT.txt doc for list of files)
